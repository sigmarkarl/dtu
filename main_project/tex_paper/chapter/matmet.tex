...
\caption{Plot of the average Pearson Correlation Coefficent of the 5 test for the PSSM on each of the 35 alleles. The alleles are ordered by the number of binding peptide insside the data, the order is the following:
