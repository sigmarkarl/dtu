...
The same data as from the PSSM section is used for comparison. For the HLA-A*0201 dataset and sparse encoding we get the following displayed in table \ref{fig:svm1}.
