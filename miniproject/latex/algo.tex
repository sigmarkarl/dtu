...
\par In order to avoid Overfitting \cite{wiki:overfit} We studied the relsults of the Monte Carlo and the gradient decent implementations of the SMM, to find the optimal setting of the algorithms.
...
\caption{To put Sigmar fig}
\label{fig:03}
\end{figure}

\begin{figure}[!tpb]
\centerline{\includegraphics[width=9cm]{fig/barplot.pdf}}
\caption{To put Sigmar fig2}
\label{fig:04}
\end{figure}
