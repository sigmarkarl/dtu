...
\label{fig:07}
\end{figure}
\par The optimal $\lambda$ value is different for the two implementations. As we can see from Figure \ref{fig:07}, regardless the size of the dataset the Monte Carlo is more accurate with smaller value of $\lambda$ (around 0.005 and 0.01) then the gradient decent version ( best $\lambda$ around 0.002).
