...
\item SVM has the winning in dataset with few binders, best pcc 0.49 for B4001 using SVM compared to 0.3 with PSSM. \pause
\end{itemize}
\end{frame}
...
\item Z-score encoded data not performing as well as we would hope as it is based on structural/functional info on the amino acids. \pause
\end{itemize}
\end{frame}
