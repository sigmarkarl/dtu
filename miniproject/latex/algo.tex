...
\par From the barplot in Figure \ref{fig:05} we can see how the 5-fold concatenate evluation it is not better than all the single fold evaluation, but it is seems more an average of all them.
